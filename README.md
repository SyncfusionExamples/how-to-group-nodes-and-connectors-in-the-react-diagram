...
A quick-start React app that shows how to group nodes and connectors in the [React Diagram](https://www.syncfusion.com/diagram-sdk/react-diagram) component. Learn how to group nodes and connectors, programmatically and dynamically. Also learn how to update a node group and add annotations. Finally, it shows how to create a nested group.  
